...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ms="urn:schemas-microsoft-com:xslt" xmlns:dt="urn:schemas-microsoft-com:datatypes">
  ...
  <xsl:template match="Root">
    <body style="font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;">
      ...
      <p>
        If you do not complete this step by <b><xsl:value-of select="CompleteByDate" /> at midnight, local UK time</b>, your <b>provisional booking will be automatically cancelled.</b>
      </p>
