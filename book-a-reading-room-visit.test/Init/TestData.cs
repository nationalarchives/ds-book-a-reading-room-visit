            ...
            bookingContext.Seats.AddRange(new List<Seat>
                {
                    ...
                    new Seat { Id = 45, Number = "46D", SeatTypeId = 1 },
                    new Seat { Id = 46, Number = "45B", SeatTypeId = 1 },
                    new Seat { Id = 47, Number = "44B", SeatTypeId = 1 },
                    new Seat { Id = 48, Number = "37G", SeatTypeId = 1 },
                    new Seat { Id = 49, Number = "38H", SeatTypeId = 1 },
                    new Seat { Id = 50, Number = "35F", SeatTypeId = 1 },
                    new Seat { Id = 51, Number = "13A", SeatTypeId = 1 },
                    new Seat { Id = 52, Number = "13C", SeatTypeId = 1 },
                    new Seat { Id = 53, Number = "13E", SeatTypeId = 1 },
                    new Seat { Id = 54, Number = "13G", SeatTypeId = 1 },
                    new Seat { Id = 55, Number = "14E", SeatTypeId = 1 },
                    new Seat { Id = 56, Number = "25B", SeatTypeId = 1 },
                    new Seat { Id = 57, Number = "25D", SeatTypeId = 1 },
                    new Seat { Id = 58, Number = "25F", SeatTypeId = 1 },
                    new Seat { Id = 59, Number = "25H", SeatTypeId = 1 },
                    new Seat { Id = 60, Number = "26B", SeatTypeId = 1 },
                    new Seat { Id = 61, Number = "26D", SeatTypeId = 1 },
                    new Seat { Id = 62, Number = "26F", SeatTypeId = 1 },
                    new Seat { Id = 63, Number = "26H", SeatTypeId = 1 },
                    new Seat { Id = 64, Number = "33B", SeatTypeId = 1 },
                    new Seat { Id = 65, Number = "33D", SeatTypeId = 1 },
                    new Seat { Id = 66, Number = "33F", SeatTypeId = 1 },
                    new Seat { Id = 67, Number = "33H", SeatTypeId = 1 },
                    new Seat { Id = 68, Number = "34B", SeatTypeId = 1 },
                    new Seat { Id = 69, Number = "34D", SeatTypeId = 1 },
                    new Seat { Id = 70, Number = "34F", SeatTypeId = 1 },
                    new Seat { Id = 71, Number = "34H", SeatTypeId = 1 },
                    new Seat { Id = 72, Number = "19A", SeatTypeId = 1 },
                    new Seat { Id = 73, Number = "19C", SeatTypeId = 1 },
                    new Seat { Id = 74, Number = "19E", SeatTypeId = 1 },
                    new Seat { Id = 75, Number = "19G", SeatTypeId = 1 },
                    new Seat { Id = 76, Number = "20A", SeatTypeId = 1 },
                    new Seat { Id = 77, Number = "20C", SeatTypeId = 1 },
                    new Seat { Id = 78, Number = "20E", SeatTypeId = 1 },
                    new Seat { Id = 79, Number = "20G", SeatTypeId = 1 },
                    ...
                    new Seat { Id = 100, Number = "Bulk1", SeatTypeId = 4 },
                    new Seat { Id = 101, Number = "Bulk2", SeatTypeId = 4 },
